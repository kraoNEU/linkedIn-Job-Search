...
# Added Functionality for Date-wise Search also
# D = 24 hours, W - Week and M - Month
console.print("Enter Date Filter M/W/D:", style="bold green", end=" ")
inputJobDate = input()
...
async def scrapeLinkedin():
    ...
    while True:
        try:
            driver.get(
                f"https://www.linkedin.com/jobs/search/?&keywords={inputJobTitle}&location={inputJobLocation}&f_TPR=r{inputJobDate}&refresh=true&start={counter}"
            )
